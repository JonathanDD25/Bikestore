...
export class DetalleEntradaController {
    async obtenerDetalleEntrada(req, res) {
        try {
    ...
    async obtenerDetalleEntradaPorId(req, res) {
        try {
    ...
    async agregarDetalleEntrada(req, res) {
        try {
    ...
    async actualizarDetalleEntrada(req, res) {
        try {
    ...
    async eliminarDetalleEntrada(req, res) {
        try {
